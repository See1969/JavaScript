...
function defUpperStr(par) {
  return (par || 'Default text').toUpperCase();
};
...
function evenFn(n) {
  ...
  for (let x = 1; x <= n; x++) if (x % 2 === 0) myArray.push(x);
...
console.log(ageClassification(-1) === null);
console.log(ageClassification(1) === 'детский возраст');
console.log(ageClassification(24) === 'детский возраст');
console.log(ageClassification(24.01) === 'молодой возраст');
console.log(ageClassification(44) === 'молодой возраст');
console.log(ageClassification(44.01) === 'средний возраст');
console.log(ageClassification(65) === 'средний возраст');
console.log(ageClassification(65.01) === 'пожилой возраст');
console.log(ageClassification(75) === 'пожилой возраст');
console.log(ageClassification(75.01) === 'старческий возраст');
console.log(ageClassification(90) === 'старческий возраст');
console.log(ageClassification(90.01) === 'долгожители');
console.log(ageClassification(122) === 'долгожители');
console.log(ageClassification(122.01) === null);
console.log(ageClassification(150) === null);
...
function oddFn(num) {
  ...
  while (x++ < num) if (x % 2 !== 0) arr.push(x);
